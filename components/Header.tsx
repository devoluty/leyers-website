  ...
  return (
    <div className="lg:px-24 px-6 py-[5%] pb-2 flex justify-between font-epilogue">
      ...
      <div className="hidden justify-center items-center sm:flex">
        <a
          className="text-md text-gray-900 mr-10 hover:text-gray-700 bg-[#b5f1cc] rounded-md p-2"
          target="_blank"
        ...
        <a
          className="text-md text-gray-900 mr-10 hover:text-gray-700 bg-[#fcf9be] rounded-md p-2"
          href="tel:+52-222-274-2075"
        >
          <i className="fa-solid fa-phone text-md m-1"></i>Llamar ahora
        </a>
        <a
          className="text-md text-gray-900 hover:text-gray-700 m-1 bg-[#b8e8fc] rounded-md p-2"
          href="/contact"
        >
